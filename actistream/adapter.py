...
class DefaultAdapter(object):
    ...
    def get_current_site(self):
        ...
        elif "django.contrib.sites" in settings.INSTALLED_APPS and settings.SITE_ID:
        ...
        for ext in ["html", "txt"]:
            try:
                ...
                bodies[ext] = self.format_email_body(
                    render_to_string(template_name, context).strip(), ext
                )
...
def get_adapter(request=None):
    path = getattr(settings, "ACTISTREAM_ADAPTER", "actistream.adapter.DefaultAdapter")
